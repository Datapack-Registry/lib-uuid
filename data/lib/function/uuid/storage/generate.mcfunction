...
#
# @reads {storage} lib:uuid *.in.uuid
# @reads {storage} lib:uuid *.generate.hex_values
# @reads {scoreboard} lib.uuid.main
# @writes {storage} lib:uuid *.out.uuid
# @writes {storage} lib:uuid *.generate.hex_values
# @writes {storage} lib:uuid *.in.uuid
# @writes {scoreboard} lib.uuid.main $0
# @writes {scoreboard} lib.uuid.main $1
# @writes {scoreboard} lib.uuid.main $2
# @writes {scoreboard} lib.uuid.main $3
